...
<main class="container-fluid">
  <div class="row row-cols-1 row-cols-lg-2 py-4 min-vh-100">
    <div class="col">
      <div class="row gap-4">
        ...
        <div class="position-relative row">
          <img src="" id="cam1" alt="Camera 1 Stream" class="img-fluid">
    ...
    <div class="col" >
      <div class="row gap-4">
        ...
        <div class="position-relative row">
          <img src="" id="cam2" alt="Camera 2 Stream" class="img-fluid">
  ...
  <div class="row row-cols-1 row-cols-lg-3">
    <div class="col col-lg-2 border py-4">
      <div>
    ...
    <div class="col col-lg-6 border py-4">
    ...
    <div class="col col-lg-4 border py-4">
