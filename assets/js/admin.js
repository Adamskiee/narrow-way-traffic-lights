...
async function deleteAdmin(id) {
    try {
      const response = await fetch("../superadmin/delete-admin.php", {
        method: "post",
        credentials: 'include',
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({"admin-id": id}),
      });
...
function loadUsers() {
    ...
    fetch("../superadmin/admins.php", {credentials: "include"})
    .then(res => res.json())
    .then(data => {
            ...
            tbody.innerHTML = `
                <tr>
                    <td colspan="7" class="text-center py-4 ">
                        ...
                        <small>Click "Add Admin" to create the first user</small>
                    </td>
                </tr>
            `;
            return;
            ...
            openInfoModal({
                ...
                body: `
                    <div class="text-center">
                        ...
                        <small class="">File: admin_export_${new Date().toISOString().split('T')[0]}.csv</small>
                    </div>
                `,
...
function setupAddUserButton() {
    ...
    if (addUserBtn && !addUserBtn.hasAttribute('data-listener-attached')) {
        ...
        addUserBtn.addEventListener("click", () => {
            ...
            modalForm.action = "../superadmin/add-admin.php";
            modalForm.method = "post";
